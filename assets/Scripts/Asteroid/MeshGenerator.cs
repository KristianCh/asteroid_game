    ...
    public void Create()
    {
        ...
        for (int i = 0; i < Subdivisions; i++)
        {
            ...
            foreach (var tri in faces)
            {
                ...
                int a = getMiddlePoint(tri.v1, tri.v2, ref vertList, ref middlePointIndexCache, Size);
                int b = getMiddlePoint(tri.v2, tri.v3, ref vertList, ref middlePointIndexCache, Size);
                int c = getMiddlePoint(tri.v3, tri.v1, ref vertList, ref middlePointIndexCache, Size);
        ...
        List<Vector3> vertListOffset = new List<Vector3>();
