...
{
	float x_offset = 1/textureSize(original,0).x;
	float y_offset = 1/textureSize(original,0).y;
...
void main()
{
	...
	vec2 screenResolution = vec2(viewport.z, viewport.w) * (3 + sin(time.x/25)*0.025);
